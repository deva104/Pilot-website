...
|---|---|---|
| `hero.png` | 1200 × 900 px | A vehicle approaching or passing through a housing society gate. The barrier arm should be visible (lifting or open). Daylight, real environment — not a studio mockup. Conveys automatic, seamless entry. |
...
- PNG is fine for web; compress large files if page load becomes slow.
